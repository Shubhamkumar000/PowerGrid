        ...
        <div className="bg-red-50 border border-red-100 rounded-lg p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h3 className="text-2xl font-bold text-red-700 mt-1">{alerts.filter(alert => alert.severity === "high").length}</h3>
            </div>
        ...
        <div className="bg-yellow-50 border border-yellow-100 rounded-lg p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h3 className="text-2xl font-bold text-yellow-700 mt-1">{alerts.filter(alert => alert.severity === "medium").length}</h3>
            </div>
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-lg p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h3 className="text-2xl font-bold text-blue-700 mt-1">{alerts.filter(alert => alert.severity === "low").length}</h3>
            </div>
        ...
        <div className="bg-green-50 border border-green-100 rounded-lg p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h3 className="text-2xl font-bold text-green-700 mt-1">{alerts.filter(alert => alert.status === "resolved").length}</h3>
            </div>
